		...
		<div className="py-20">
			...
			<div className="flex flex-wrap items-center justify-center p-4 gap-x-20 gap-y-8 mt-10">
				{projects.map(({ id, title, des, img, iconLists, link }) => (
					<div
						key={id}
						className="h-[24rem] sm:h-[25rem] lg:h-[27rem] xl:h-[27rem] flex items-center justify-center sm:w-[45vw] lg:w-[39vw] xl:w-[33rem] w-[35rem] my-3 lg:my-4"
					>
						<PinContainer title={link} href={link}>
							<div className="relative flex items-center justify-center sm:w-[27rem] xl:w-[40vw] w-[80vw] overflow-hidden h-[30vh] sm:h-[25vh] my-12">
